...
import { Wallets, ConnectedWallet, walletconnect } from "../utils/wallet";
...
import { switchNetwork, useEagerConnect, useInactiveListener } from "../hooks";
...
const Cwallet = ({ isOpen, setIsOpen }) => {
  ...
  return (
    ...
    >
            ...
            if (isSelectingWallet) {
              ...
              return (
                <List>
                  ...
                  >
                    <ListItemIcon className="symbol">
                      <img src={activating.logo} alt={activating.logo} />
                    </ListItemIcon>
                    <ListItemText
      ...
      {active && (
        <Alert severity="info">Your transaction detail will appear here.</Alert>
      )}
    </Dialog>
  );
};
